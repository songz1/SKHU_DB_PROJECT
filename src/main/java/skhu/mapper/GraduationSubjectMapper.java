...
public interface GraduationSubjectMapper {
	...
	List<GraduationSubject> findByBasic(String year);
	List<GraduationSubject> findByOption(@Param("start")int start, @Param("end")int end, @Param("condition") GraduationSubject condition, @Param("searchText") String searchText);
