				...
				<table>
					<tr>
						...
						<td class="col-md-5 col-md-offset-5 text-center"><a
							href="downchangerequestlist">대체과목목록</a></td>
					</tr>
				</table>
				<hr />
				...
				<form:form action="changerequestlist" method="get" modelAttribute="condition">
					<table class="table text-center">
						<tr>
							...
							<td class="title"><select name="searchType" class="col-md-2 form-control">
				...
				<nav>
					  <ul class="pager">
					    <c:forEach var="page" items="${ pages }">
							<li>
								<a href="changerequestList?${ page.queryString }"> ${ page.label }</a>
							</li>
						</c:forEach>
					  </ul>
				</nav>
