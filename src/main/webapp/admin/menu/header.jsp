		...
		<nav class="navbar navbar-custom navbar-fixed-top navbar-color"
			...
			<div class="container-fluid">
				<div class="navbar-header">
					<a class="navbar-brand" href="/admin/menu/main.jsp">성공회대학교 졸업관리</a>
				</div>
					...
					<ul class="nav navbar-nav navbar">
						<li class="dropdown"><a href="#" class="dropdown-toggle"
							...
							<ul class="dropdown-menu">
								<li><a href="/admin/menu/graduation/basic.jsp">기본 졸업 요건</a></li>
								<li><a href="/admin/menu/graduation/detail.jsp">학과/학부별
										졸업 요건</a></li>
								<li><a href="/admin/menu/graduation/gradelist.jsp">졸업
										요건 목록 - 학점</a></li>
								<li><a href="/admin/menu/graduation/subjectlist.jsp">졸업
										요건 목록 - 과목</a></li>
						...
						<li class="dropdown"><a href="#" class="dropdown-toggle"
							...
							<ul class="dropdown-menu">
								<li><a href="/admin/menu/member/list.jsp">학생 관리</a></li>
								<li><a href="/admin/menu/account/adminList.jsp">관리자 목록</a></li>
								<li><a href="/admin/menu/account/addadmin.jsp">관리자 추가</a></li>
								<li><a href="/admin/menu/account/pwdconfirm.jsp">내 정보
										관리</a></li>
							</ul>
					</ul>
