...
<link rel="stylesheet" type="text/css" href="../../res/css/form.css?ver=2">
				...
				<div class="centered">
					<form class="form-horizontal" action="../menu/main.jsp">
						...
						<div class="form-group mt-10">
							<div class="col-sm-12">
								<input type="text" class="form-control" id="studentNumber" placeholder="아이디">
						    </div>
						</div>
						<div class="form-group">
							<div class="col-sm-12">
								<input type="password" class="form-control" id="password" placeholder="패스워드">
							</div>
						</div>
						<div>
